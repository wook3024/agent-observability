...
- [grafana/dashboards/overview.json](grafana/dashboards/overview.json:127)
- [grafana/dashboards/api-requests.json](grafana/dashboards/api-requests.json:77)
- [grafana/dashboards/tool-analytics.json](grafana/dashboards/tool-analytics.json:199)
- [grafana/dashboards/events-explorer.json](grafana/dashboards/events-explorer.json:301)
- [grafana/dashboards/prompt-analytics.json](grafana/dashboards/prompt-analytics.json:229)
- [grafana/dashboards/prompt-detail.json](grafana/dashboards/prompt-detail.json:487)
- [grafana/dashboards/trace-explorer.json](grafana/dashboards/trace-explorer.json:356)
- [loki-config.yml](loki-config.yml:28)
- [otel-collector-config.yml](otel-collector-config.yml:20)
